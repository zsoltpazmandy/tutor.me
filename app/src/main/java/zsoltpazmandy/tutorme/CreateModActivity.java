...
//                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            System.out.println(new JSONObject(data.getStringExtra("Module complete")));
        } catch (JSONException e) {
            e.printStackTrace();
        }
//        if (resultCode == 1) {
...
//
//        int slideType = Integer.parseInt(module.get(7));
//
...
//
//
//        if (slideType == 1) { // it's a TextSlide
//
...
//                int num = i + 1;
//                moduleJSON.put("Slide #" + num, module.get(7 + i).trim());
//            }
//        }
//
//        if (slideType == 2) { // it's a TableSlide
//            int j = 1;
//            for (int i = 7; i < module.size(); i++) {
//
//                moduleJSON.accumulate("Slide #" + j, module.get(i));
//                i++;
//                moduleJSON.accumulate("Slide #" + j, module.get(i));
//                j++;
//
